...
if (isset($_POST['btn-submit'])) {
	...
	$sqlCheck="SELECT * FROM danhmuc_tintuc WHERE ten_dmtt='$ten_dmtt'";
	...
	$sql="INSERT INTO danhmuc_tintuc(ten_dmtt,trangthai) VALUES('$ten_dmtt','$trangthai')";
		...
		<div class="content">
			<form action="" method="post">
				<div class="form-group">
					...
					<input type="text" name="ten_dmtt" placeholder="Nhập tên danh mục tin tức...">
				</div>
				<div class="form-group">
