...
if (isset($_POST['btn-submit'])) {
	...
	$sqlCheckSDT="SELECT * FROM admin WHERE sdt_ad='$sdt'";
	...
	$sql="INSERT INTO admin(ten_ad,email_ad,sdt_ad,matkhau_ad,diachi_ad) VALUES('$ten','$email','$sdt','$matkhau','$diachi')";
...
<div class="content-right">
	<div class="path">
		<ul>
			...
			<li><a href="index.php">Quản lý admin</a></li>
